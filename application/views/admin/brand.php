								...
								<table id="dataTable3" class="text-center">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<button type="button" class="btn btn-success btn-flat btn-lg mt-3" onclick="window.location.href='<?= base_url('admin/updateView/') . 'brand/' . $b['id_brand'] ?>'">Update</button>
												<button type="button" class="btn btn-danger btn-flat btn-lg mt-3" onclick="window.location.href='<?= base_url('admin/deleteBrand/') . $b['id_brand'] ?>'">Hapus</button>
											</td>
